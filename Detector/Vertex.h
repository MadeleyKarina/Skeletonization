...
class Face;
          ...
          class Vertex{
                ...
                public:
						...
						int getNumberAdjacentFaces(){return faces.size();}
						
						void getPatch(Vertex* vertices, vector<int> indices, set<int>& returned, set<int>& faceR, double radius, Vertex center);
						
						void setNumFace(int num){numFace = num;}
						int getNumFace(){return numFace;}
						
						void setPosBarycentric(int pos){posBarycentric = pos;}
						int getPosBarycentric(){return posBarycentric;}
		};
